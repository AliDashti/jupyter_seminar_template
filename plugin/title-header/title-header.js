/********************************************************
*                                                       *
* Javascript for the Title-header plugin for Reveal.js  *
*                                                       *
* Author: Igor Leturia                                  *
*                                                       *
* License: GPL v3                                       *
...
/* Title-header object and properties declaration with default values */
...
title_header.getElementsByTagNames=function(list,obj)
{
	if (!obj)
	{
		var obj=document;
...
/* Method to initialize the Title-header header */

title_header.initialize=function(title,background)
{

	// Link to the Title-header CSS

	var link=document.createElement("link");
	link.href="plugin/title-header/title-header.css";
	link.type="text/css";
	link.rel="stylesheet";
	...
	title_header.setAttribute('style','background:'+this.background);
	var title_header_p=document.createElement('p');
	title_header.appendChild(title_header_p);
	var a_element=document.createElement('a');
	a_element.setAttribute('href','#/0');
	a_element.appendChild(document.createTextNode(this.title));
	title_header_p.appendChild(a_element);
